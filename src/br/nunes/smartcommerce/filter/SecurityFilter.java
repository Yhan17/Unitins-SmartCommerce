...
//		System.out.println(endereco);
		if (endereco.equals("/SmartCommerce/") 
				|| endereco.equals("/SmartCommerce/index.xhtml")
				||endereco.equals("/SmartCommerce/login.xhtml")
				||endereco.equals("/SmartCommerce/register.xhtml")
				||endereco.equals("/SmartCommerce/about.xhtml")
				||endereco.equals("/SmartCommerce/product_page.xhtml")) {
			chain.doFilter(request, response);
			return;
		}
		...
		if ( usuario == null) {
			...
			|| endereco.equals("/SmartCommerce/carrinho.xhtml")
			|| endereco.equals("/SmartCommerce/detalhesvenda.xhtml")
			|| endereco.equals("/SmartCommerce/payment.xhtml")
			|| endereco.equals("/SmartCommerce/product_page.xhtml")
			|| endereco.equals("/SmartCommerce/user_profile.xhtml"))) {
				chain.doFilter(request, response);
				return;	
			...
			|| endereco.equals("/SmartCommerce/user_profile.xhtml")
			||endereco.equals("/SmartCommerce/about.xhtml")
			||endereco.equals("/SmartCommerce/product_page.xhtml")) && usuario.getIs_admin() == true) {
				chain.doFilter(request, response);
				return;
			}	
